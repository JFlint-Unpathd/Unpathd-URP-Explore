...
public class SpawnSFR : MonoBehaviour
{
    ...
    private void SpawnObjects()
    {
        ...
        {
            float angle = i * (360f / objectsToSpawn.Length);
            Vector3 spawnOffset = new Vector3(Mathf.Cos(Mathf.Deg2Rad * angle), 0f, Mathf.Sin(Mathf.Deg2Rad * angle)) * spawnRadius;

            Vector3 spawnPosition = originalObjectPosition + spawnOffset;
